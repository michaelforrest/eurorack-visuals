...
final class BluetoothSerial: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    var connectedPeripheral: CBPeripheral?{
        didSet{
            print("Changed connected peripheral", connectedPeripheral)
    ...
    func startScan() {
        guard centralManager.state == .poweredOn else { print("Central Manager not powered on"); return }
...
//        guard isReady else { return }
        ...
        connectedPeripheral!.writeValue(Data(bytes: bytes), for: writeCharacteristic!, type: writeType)
    }
